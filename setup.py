...
setup(
    ...
    install_requires=['aniso8601==9.0.1', "asgiref==3.5.1; python_version >= '3.7'", 'django==4.2.16',
                      ...
                      'ofxtools==0.9.5', 'pillow==10.3.0', 'promise==2.3', "pyjwt==2.4.0; python_version >= '3.6'",
                      "python-dateutil==2.8.2; python_version >= '2.7' and python_version not in '3.0, 3.1, 3.2, 3.3'",
                      "six==1.16.0; python_version >= '2.7' and python_version not in '3.0, 3.1, 3.2, 3.3'",
                      "sqlparse==0.5.0; python_version >= '3.5'", 'text-unidecode==1.3',
